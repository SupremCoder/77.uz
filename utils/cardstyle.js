...
export function listViewStyle(product) {
  ...
  listCard.innerHTML = `
        <div class="list-view__card-symbols">
            <img class="list-view__card-image card-image" src="${product.photo
    }" alt="Product photo" />
        </div>
        <div class="list-view__card-content">
            <div class="list-view__top-content">
                ...
                <span class="badge card-address"> ${product.address.district.name
    }</span>
            </div>
      ...
      product.published_at,
            ...
            <a class="list-view__card-number card-phoneNum" href="tel:${product.seller.phone_number
...
export function gridViewStyle(product) {
  ...
  grid_card.innerHTML = `
         ...
         <div class="grid-view__card-symbols">
           ...
           <iconify-icon id="${product.id
    }" class="icon" icon="tabler:heart-filled"></iconify-icon>
           </div>
           <img class="grid-view__card-image card-image" src="${product.photo
    }" alt="Product photo" />
         </div>
         <div class="grid-view__card-content">
           <span class="badge card-address">${product.address.district.name
    }</span>
           <a href="../../pages/productSingle/ProductSingle.html" class="grid-view__card-title card-title">${product.name
    }</a>
           <p class="grid-view__card-date card-date">${dateFormatter(
      product.published_at,
    )}</p>
           <a class="grid-view__card-number card-phoneNum" href="tel:${product.seller.phone_number
    }">${phoneNumberFormatter(product.seller.phone_number)}</a>
